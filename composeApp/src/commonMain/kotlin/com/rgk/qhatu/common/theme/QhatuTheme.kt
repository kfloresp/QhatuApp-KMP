...
import qhatuapp.composeapp.generated.resources.Poppins_Regular
import qhatuapp.composeapp.generated.resources.Res

@Composable
fun QhatuTheme(content: @Composable () -> Unit) {
    val typography = Typography().defaultFontFamily(FontFamily(Font(Res.font.Poppins_Regular)))
    val colorScheme = if (isSystemInDarkTheme()) darkColorScheme() else lightColorScheme()
    MaterialTheme(content = content, typography = typography, colorScheme = colorScheme)
}
