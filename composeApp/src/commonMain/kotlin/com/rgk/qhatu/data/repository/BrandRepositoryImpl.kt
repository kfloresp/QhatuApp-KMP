...
import com.rgk.qhatu.data.database.dao.BrandDao
import com.rgk.qhatu.data.remote.BrandRemoteDataSource
...
class BrandRepositoryImpl(
    ...
    override suspend fun updateLocal(register: Brand): SyncResult<Boolean> {
        return try {
