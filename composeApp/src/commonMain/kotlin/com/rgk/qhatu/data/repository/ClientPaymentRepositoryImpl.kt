...
import com.rgk.qhatu.data.database.dao.ClientPaymentDao
import com.rgk.qhatu.data.remote.ClientPaymentRemoteDataSource
...
class ClientPaymentRepositoryImpl(
    ...
    override suspend fun updateLocal(register: ClientPayment): SyncResult<Boolean> {
        return try {
    ...
    override suspend fun saveLocal(registers: List<ClientPayment>): SyncResult<Boolean> {
        return try {
