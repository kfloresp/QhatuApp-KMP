...
import com.rgk.qhatu.data.database.dao.TransactionDao
import com.rgk.qhatu.data.remote.TransactionRemoteDataSource
...
class TransactionRepositoryImpl(
    ...
    override suspend fun updateLocal(register: Transaction): SyncResult<Boolean> {
        return try {
    ...
    override suspend fun saveLocal(registers: List<Transaction>): SyncResult<Boolean> {
        return try {
